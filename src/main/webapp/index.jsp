...
<!--start slider -->
    <link rel="stylesheet" href="${contextPath}/resources/css/fwslider.css" media="all">
    <script src="${contextPath}/resources/js/jquery-ui.min.js"></script>
    <script src="${contextPath}/resources/js/css3-mediaqueries.js"></script>
    <script src="${contextPath}/resources/js/fwslider.js"></script>
<!--end slider -->
  ...
  <!-- start slider -->
    <div id="fwslider">
        <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
                    <img src="${contextPath}/resources/images/banner.jpg" alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
            ...
            <div class="slide">
                <img src="${contextPath}/resources/images/banner1.jpg" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
		  ...
		  <div class="top-box1">
			...
			<div class="rsidebar span_1_of_left">
				<div class="top-border"> </div>
				 <div class="border">
	             <link href="${contextPath}/resources/css/default.css" rel="stylesheet" type="text/css" media="all" />
	             <link href="${contextPath}/resources/css/nivo-slider.css" rel="stylesheet" type="text/css" media="all" />
				  <script src="${contextPath}/resources/js/jquery.nivo.slider.js"></script>
		    ...
		    <div class="slider-wrapper theme-default">
              <div id="slider" class="nivoSlider">
                <img src="${contextPath}/resources/images/t-img1.jpg"  alt="" />
               	<img src="${contextPath}/resources/images/t-img2.jpg"  alt="" />
                <img src="${contextPath}/resources/images/t-img3.jpg"  alt="" />
              </div>
             </div>
