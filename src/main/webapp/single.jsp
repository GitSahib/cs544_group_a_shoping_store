...
<!-- start details -->
<script src="${contextPath}/resources/js/slides.min.jquery.js"></script>
   <script>
		$(function(){
			$('#products').slides({
				preload: true,
  ...
  <div class="main">
     <div class="wrap">
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="${contextPath}/resources/images/s-img.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="${contextPath}/resources/images/s1.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="${contextPath}/resources/images/s-img1.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="${contextPath}/resources/images/s2.jpg" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="${contextPath}/resources/images/s-img2.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="${contextPath}/resources/images/s3.jpg" class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="${contextPath}/resources/images/s4.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="${contextPath}/resources/images/s-img3.jpg" class="img-responsive"  />
							</li>
						</ul>
	    ...
	    <h3 class="m_3">10 Other Products in the same category</h3>
		 <ul id="flexiselDemo3">
			<li><img src="${contextPath}/resources/images/s5.jpg" /><a href="#">Category</a><p>Rs 600</p></li>
			<li><img src="${contextPath}/resources/images/s6.jpg" /><a href="#">Category</a><p>Rs 850</p></li>
			<li><img src="${contextPath}/resources/images/s7.jpg" /><a href="#">Category</a><p>Rs 900</p></li>
			<li><img src="${contextPath}/resources/images/s8.jpg" /><a href="#">Category</a><p>Rs 550</p></li>
			<li><img src="${contextPath}/resources/images/s9.jpg" /><a href="#">Category</a><p>Rs 750</p></li>
		 </ul>
