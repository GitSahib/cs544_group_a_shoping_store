...
<script type="text/javascript"
	src="${contextPath}/resources/js/jquery1.min.js"></script>
<!-- start menu -->
<link href="${contextPath}/resources/css/megamenu.css" rel="stylesheet"
	type="text/css" media="all" />
<script type="text/javascript"
...
<!--start slider -->
<link rel="stylesheet" href="${contextPath}/resources/css/fwslider.css"
	media="all">
